...
from .views import PostDetailView, PostCreateView, PostListView, PostUpdateView, PostDeleteView, UserPostListView, AddCommentView, UserCommentListView, GalleryListView, Delete_Comment, About
from . import views


urlpatterns = [
    path('forum/', PostListView.as_view(), name='forum'),#blog-home
    ...
    path('', About.as_view(), name='home'),#blog-about
] 
